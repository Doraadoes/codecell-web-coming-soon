...
const SyrusFooter = () => {
  return (
    <div className="footer">
      <a href="/" className="footer-codecell">
        <img src={CodecellLogo} alt="CodeCell" />
        <span className="footer-codecell-text">CodeCell++</span>
      </a>

      <div className="footer-vesit">
        <div className="vesit-name">
          <img src={VESITLogo} alt="VESIT" />
